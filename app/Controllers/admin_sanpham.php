...
<div class="sidebar">
    ...
    <a href="dangxuatadmin.php"><i class="fa-solid fa-right-from-bracket me-2"></i> Đăng Xuất</a>
</div>
            ...
            <tbody>
                ...
                if ($result && $result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='xuly_xoa_sanpham.php?id=" . $row["id"] . "' class='btn btn-sm btn-outline-danger' onclick='return confirm(\"Bạn chắc chắn muốn xóa sản phẩm này?\")'>
