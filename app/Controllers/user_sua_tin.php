...
// 2. Kiểm tra ID
if (!isset($_GET['id'])) {
    header("Location: ../../resources/views/user/user_dashboard.php"); // Nếu lỗi ID thì về Dashboard luôn
    exit;
}
$id = $_GET['id'];
...
if ($result->num_rows == 0) {
    echo "<script>alert('Tin không tồn tại hoặc bạn không có quyền sửa!'); window.location.href='../../resources/views/user/user_dashboard.php';</script>";
    exit;
}
...
if (isset($_POST['btn_update'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        $target_dir = "../../../uploads/"; // Sửa đường dẫn đến thư mục uploads ở gốc
        $new_filename = time() . "_" . basename($_FILES["image"]["name"]); 
        $target_file = $target_dir . $new_filename;
        
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            $db_image_path = "uploads/" . $new_filename; // Đường dẫn lưu vào DB
    ...
    if ($conn->query($sql_update) === TRUE) {
        ...
        echo "<script>
                ...
                window.location.href='../../resources/views/user/user_dashboard.php'; 
              </script>";
    } else {
        echo "Lỗi: " . $conn->error;
    }
...
<div class="sidebar">
    <div class="brand"><a href="../../resources/views/user/user_dashboard.php" style="color: #ff9f43; text-decoration: none;"><i class="fa-solid fa-store"></i> KÊNH NGƯỜI BÁN</a></div>
    <a href="../../resources/views/user/user_dashboard.php" class="active"><i class="fa-solid fa-gauge me-2"></i> Tổng Quan</a>
    <a href="../../resources/views/user/user_dangtin.php"><i class="fa-solid fa-pen-to-square me-2"></i> Đăng Tin Mới</a>
    <a href="../../resources/views/user/user_quanlytin.php"><i class="fa-solid fa-list me-2"></i> Tin Đã Đăng</a>
    <a href="dangxuat.php"><i class="fa-solid fa-right-from-bracket me-2"></i> Đăng Xuất</a>
</div>

<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="text-secondary">Chỉnh Sửa Tin Đăng</h3>
        <a href="../../resources/views/user/user_dashboard.php" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="card card-custom p-4">
        ...
        <form method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <?php 
                            ...
                            $img_src = ($img_row && !empty($img_row['filename'])) ? '../../resources/views/' . $img_row['filename'] : 'https://via.placeholder.com/300x300?text=No+Image';
                        ?>
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="../../resources/views/user/user_dashboard.php" class="btn btn-secondary px-4">Hủy bỏ</a>
