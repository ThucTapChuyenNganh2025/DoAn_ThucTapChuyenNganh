...
if (isset($_POST['submit'])) {
    ...
    if (!password_verify($old, $users['password'])) {
        ...
        echo "<script>alert('Đổi mật khẩu thành công!'); window.location='../../resources/views/user/profile.php';</script>";
        exit();
    }
}
?>
    ...
    <div class="container mt-5">
        <div class="card p-4 shadow">
            ...
            <form method="POST">
                ...
                <a href="../../resources/views/user/profile.php" class="btn btn-secondary">Hủy</a>
            </form>
