                ...
                <div class="card shadow-lg p-4 border-0">
                    ...
                    <form>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="../../../app/Controllers/update_profile.php" class="btn btn-danger">Cập nhật hồ sơ</a>
                            <a href="../../../app/Controllers/doimk.php" class="btn btn-danger text-white">Đổi mật khẩu</a>
                            <a href="user_dashboard.php" class="btn btn-secondary">Về trang Kênh Người Bán</a>
                        </div>
