...
$stmt->execute();
$user_name = $stmt->get_result()->fetch_assoc()['name'] ?? "Người dùng";
$stmt->close();
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="text-secondary mb-0">Xin chào, <?php echo htmlspecialchars($user_name); ?>!</h3>
        <?php if (!isset($_SESSION['user_id'])): ?>
            <a href="../../../app/Controllers/dangnhap.php" class="btn btn-danger">Đăng Nhập</a>
        <?php endif; ?>
    </div>
            ...
            <tbody>
                ...
                if ($result && $result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>$stt</td>";
                        echo "<td>
                                <a href='../../../app/Controllers/user_sua_tin.php?id=" . $row['id'] . "' class='btn btn-sm btn-outline-primary'><i class='fa-solid fa-pen'></i> Sửa</a>
                                
                                <a href='../../../app/Controllers/user_xoa_tin.php?id=" . $row['id'] . "' 
